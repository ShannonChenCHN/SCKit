...
#import "SCHourglassLoadingView.h"
#import "NSTimer+SCExtension.h"

@interface SCHourglassLoadingView ()
...
@implementation SCHourglassLoadingView
...
- (void)p_setupSubviews {
    ...
    _messageLabel.textColor = [UIColor colorWithRed:17/255.0 green:17/255.0 blue:17/255.0 alpha:1.0];;
...
- (void)startAnimating {
    ...
    self.timer = [NSTimer sc_timerWithTimeInterval:0.5 repeats:YES block:^(NSTimer *timer) {
